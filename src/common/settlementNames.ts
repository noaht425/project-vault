...
export const NOTABLE_TRAITS: string[] = [
  ...
  'Chews their hair',
  "Really doesn't like drinking water",
  "Doesn't shave",
  'Is bad at shaving',
  'Wakes up really late in the day',
  'Wakes up really early',
  'Likes to party',
  "Claims that they're not racist",
  "Doesn't believe in the government",
  "Claims they're taller than they are",
  'Has trouble deciding which eye to look at when talking to people',
  'Claims that they can fix anything',
  'Is really good at fixing things',
  'Only uses scented candles',
  'Has sensory issues',
  'Thinks that they\'re a monster (vampire, werewolf, etc.)',
  'Very scholarly',
  'Likes insects',
  'Allergic to a specific food',
  "Can't taste",
  'Carries a key ring',
  'Has unfinished letters in pockets',
  'Wears a really big coat',
  'Clothes are too big',
  'Clothes are too small',
  'Has very high self-confidence',
  'Has very low self-confidence',
  'Stares at shadows',
  'Shares weird animal facts',
  'Stares at chairs before sitting in them',
  "Doesn't have a lot of friends but says they do",
  'Tells bad jokes'
]
...
export const NOTABLE_GOALS: string[] = [
  ...
  'is chasing after a lover who scorned them',
  'tries to collect romantic partners',
  'collects a specific item',
  'wants to forget',
  'wants to be taller',
  ...
  'wants to fix a childhood trinket',
  'is looking for a lost family heirloom',
  'wants certain laws to change',
  'wants to make people laugh',
  'wants to create something new',
  'wants to become a legend',
  'wants to be an author',
  'wants to be trusted',
  'wants to trust people more',
  'wants to find belonging',
  'wants to find a found family',
  'wants new clothes',
  'wants to be different from their parents',
  'wants to be just like their parents',
  'wants to honor their ancestors',
  'wants to bring back a tradition',
