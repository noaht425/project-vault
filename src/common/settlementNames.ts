...
export const NOTABLE_TRAITS: string[] = [
  ...
  'Dry sense of humor',
  'Overly formal with everyone',
  'Easily flattered',
  'Stubborn as a mule',
  'Quick to laugh, quicker to forget why',
  'Keeps everyone at arm\'s length',
  'Fiercely competitive',
  'Painfully honest',
  'Chronically late, always apologetic',
  ...
  'Anxious but hides it well',
  'Coldly efficient',
  'Warm to strangers, cold to regulars',
  'Easily distracted',
  ...
  'Fast talker, faster thinker',
  'Painfully shy around strangers',
  'Domineering but well-meaning',
  'Easily bored',
  'Meticulously polite',
  'Suspicious of newcomers',
  'Generous to strangers, stingy with family',
  ...
  'Calculates every risk twice',
  'Naturally commanding presence',
  'Prone to daydreaming mid-conversation',
  'Trusts actions over words',
  'Keeps a running mental ledger of favors',
  'Unfailingly punctual',
...
export const NOTABLE_GOALS: string[] = [
  ...
  'wants to open a second location before a rival does',
  'is secretly in love with someone who doesn\'t know it',
  'wants to win back a family heirloom lost to debt',
  'is trying to prove themselves to a disapproving parent',
  'wants their name remembered after they\'re gone',
  'is quietly building a rainy-day fund no one knows about',
  'wants to travel somewhere they\'ve only heard about in stories',
  'is trying to reconcile with an estranged sibling',
  'wants to be trusted with something bigger than this shop',
  'is haunted by a mistake from years ago',
  'wants to adopt a child but hasn\'t found the courage to ask',
  'is trying to outlive a prophecy they don\'t believe in',
  'wants revenge on someone who wronged their family',
  'is saving up to buy back land their family once owned',
  'wants to be remembered as more than just their trade',
  'is quietly training a successor no one\'s noticed yet',
  'wants approval from someone who will never give it',
  'is trying to solve a mystery about their own past',
  'wants to marry well above their station',
  'is protecting someone by keeping their distance',
  'wants one big score to finally retire comfortably',
  'is trying to win a rivalry that started over something trivial',
  'wants to prove a doubted skill wasn\'t a fluke',
  'is quietly grieving a loss no one else knows about',
  'wants their child to never have to work as hard as they did',
  'is trying to buy their way into respectability',
  'wants forgiveness from someone who\'s already gone',
  'is secretly funding someone else\'s dream',
  'wants to be the one who finally fixes this town\'s biggest problem',
  'is trying to outrun a reputation from somewhere else',
  'wants a family member to finally visit',
  'is quietly planning to leave everything behind one day',
  'wants to settle an old debt of honor, not coin',
  'is trying to earn a place they feel they don\'t deserve',
  'wants to pass down a skill before it\'s forgotten',
  'is secretly terrified of failing the people who depend on them',
  'wants recognition from a guild that\'s overlooked them for years',
  'is trying to win someone\'s trust back after breaking it',
  'wants to build something that outlasts them',
  'is quietly saving for a wedding no one\'s approved of',
  'wants to prove their family\'s name still means something',
  'is trying to make peace with a rival before it\'s too late',
  'wants to find out what happened to someone who vanished',
  'is secretly hoping someone will ask them to leave with them',
  'wants one honest conversation with someone they\'ve never had'
]
