// Client-side driver for the fight simulator. Prefers a Web Worker (keeps the
// window responsive during a long sweep); falls back to a synchronous run on
// the main thread if a worker can't be constructed.
