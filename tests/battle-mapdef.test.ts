...
import {
  ...
  setTerrain,
  type BattleMapDef,
} from "../src/common/sim/battle/grid";
import { battleRoster, autoPlace, runBattle } from "../src/common/sim/battle";
import { standardParty } from "../src/common/sim/engine/scenario";
...
describe("runBattleFromSetup honours setup.battleMap", () => {
  it("a walled-off map still resolves and uses the given dimensions", async () => {
    const { runBattleFromSetup } = await import("../src/common/sim/ui");
