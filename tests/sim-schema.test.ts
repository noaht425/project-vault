...
import {
  ...
  type AutomationNode,
  type Combatant,
} from "../src/common/sim/schema";
import { ALL_FIXTURES, FIXTURES_BY_ID } from "../src/common/sim/fixtures";
import { averageOfDice, validateAll, validateCombatant } from "../src/common/sim/validate";
