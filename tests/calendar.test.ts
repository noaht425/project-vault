...
import { calendarFrontmatterSchema, defaultCalendarFrontmatter } from '../src/common/noteTypes/calendar'
...
describe('calendarFrontmatterSchema', () => {
  it('round-trips the user\'s own Age of the Many/Few calendar shape', () => {
    const fm = calendarFrontmatterSchema.parse({
      type: 'calendar',
      summary: 'The main calendar of Project Planar.',
      eras: [
