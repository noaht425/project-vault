...
import { runBattle } from "../src/common/sim/battle";
import type { BattleDecision } from "../src/common/sim/battle/control";
import type { ReactionChoice } from "../src/common/sim/battle/state";
