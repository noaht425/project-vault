...
import { defaultBuildingTypes, defaultWealthTiers, type CustomFactionDef } from '../src/common/noteTypes/settlement'
import { FACTION_NAME_POOL } from '../src/common/settlementNames'
